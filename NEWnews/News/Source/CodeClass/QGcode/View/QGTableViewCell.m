...
{
    if (_aImageVew == nil) {
        self.aImageVew = [[UIImageView alloc]initWithFrame:CGRectMake(CGRectGetMinX(self.contentView.frame)+5, CGRectGetMinY(self.contentView.frame)+5, 100, CGRectGetHeight(self.contentView.frame)-10)];
